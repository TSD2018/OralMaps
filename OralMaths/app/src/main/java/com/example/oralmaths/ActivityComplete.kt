...
//        analysisDataAttempted.text = analytics.
            ...
            */
            1 -> {
                ...
                var staticLabelFormatterGraph3 = StaticLabelsFormatter(graph3)
...
//                graph3.viewport.setMaxY(100.0)
                graph3.viewport.isXAxisBoundsManual = true
//                graph3.viewport.isYAxisBoundsManual = true
...
//                series.appendData(DataPoint(3.0, 0.0), true, 5)
//                series.appendData(DataPoint(4.0, 0.0), true, 5)
//                series.appendData(DataPoint(5.0, 0.0), true, 5)
//                series1.spacing = 50
//                series2.spacing = 50
//        series1.isAnimated = true

                var staticLabelFormatter = StaticLabelsFormatter(graph)
                staticLabelFormatter.setHorizontalLabels(arrayOf("", "Attempt\nRate", "Strike\nRate", ""))
//                staticLabelFormatter.setHorizontalLabels(arrayOf("", "Attempt Rate", "Strike Rate", "# Attempts", "Error", "TimeOuts"))
...
//                seriesAttemptRate.isAnimated = true
//                seriesAttempts.setColor(Color.GRAY)
//                seriesErrors.setColor(Color.RED)
//                seriesTimeOuts.setColor(Color.LTGRAY)
...
//                graph.addSeries(seriesAttempts)
//                graph.addSeries(seriesErrors)
//                graph.addSeries(seriesTimeOuts)
